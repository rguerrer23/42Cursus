...
/*   Updated: 2024/02/05 16:14:48 by rguerrer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->map[y][x] == 'E')
		mlx_image_to_window(game->mlx->mlx, game->img->img_exit, x * 32, y
			* 32);
	else
	{
		mlx_image_to_window(game->mlx->mlx, game->img->img_exit, x * 32, y
			* 32);
		mlx_image_to_window(game->mlx->mlx, game->img->img_player, x * 32, y
			* 32);
	}
}
