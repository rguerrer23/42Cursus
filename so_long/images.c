...
/*   Updated: 2024/01/19 18:01:23 by rguerrer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_get_images(t_game *game)
{
	...
	game->img->img_wall = mlx_texture_to_image(game->mlx->mlx, game->png->img_wall);
	game->img->img_player = mlx_texture_to_image(game->mlx->mlx,
			game->png->img_player);
	game->img->img_exit = mlx_texture_to_image(game->mlx->mlx, game->png->img_exit);
